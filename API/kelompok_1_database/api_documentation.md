...
> Super Admin dapat mengakses **seluruh 44 endpoint**. Di bawah ini hanya endpoint yang secara eksklusif atau utama dimiliki Super Admin.
...
Menampilkan data user mahasiswa berdasarkan NIM, termasuk prodi_id, nama_prodi, dan semester_sekarang (diambil dari `k_h_s` tertinggi).
